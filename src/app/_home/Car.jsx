    ...
    <section className="bg-[#f3f3f4] py-10 sm:py-16 md:py-20 lg:py-22 my-10 sm:my-14 md:my-16 lg:my-19 max-sm:py-20 ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 max-sm:gap-0 max-sm:items-start max-sm:mb-0 max-sm:justify-items-flex-start max-md:justify-items-flex-start max-md:items-start max-md:mb-0  max-md:gap-0  ">
          ...
          <Link
            href="/car"
            className=" max-md:hidden max-sm:hidden sm:hidden bg-[#ff2525] flex justify-center items-center gap-1 mx-1 rounded-lg text-white px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 text-sm sm:text-base transition-all duration-300 hover:bg-[#ff3232] max-md:text-nowrap max-lg:text-nowrap max-sm:w-fit "
          >
            Explore Now{" "}
        ...
        <Link
          href="/car"
          className=" max-sm:hidden mt-7 md:mt-0 bg-[#ff2525] flex justify-center  items-center gap-2 rounded-lg text-white px-6 py-3 text-base font-semibold transition-all duration-300 hover:bg-[#ff3232]"
        >
