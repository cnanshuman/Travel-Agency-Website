  ...
  return (
    <footer className="bg-black text-gray-300 py-12 px-6 mt-10">
      <div className="max-w-9xl mx-auto flex flex-col md:flex-row justify-between">
        <div className="w-[full] md:w-[60%] grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
               ...
               <li>
                <Link href="/testimonials">Our Vechicle</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/testimonials">Happy Cient</Link>
              </li>
              <li>
        ...
        <div className="w-full md:w-[20%] mt-10 md:mt-0">
          <h4 className="text-sm font-semibold text-gray-400 mb-4 tracking-wider text-left md:text-right">
            FOLLOW US
          </h4>
      ...
      <div className="max-w-9xl mx-auto border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
