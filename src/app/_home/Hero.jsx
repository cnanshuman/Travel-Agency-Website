...
<div className="mt-8  flex items-center justify-center gap-2 px-2 text-center"><p className="text-[10px] md:text-[13px] font-semibold text-gray-700 leading-tight">Explore the all-new Customized Holiday Packages from KulbirTravels - Avail <span className="bg-[#c1082b] text-white px-2 py-0.5 font-black rounded mx-1">15% OFF</span> on your next Outstation Booking.</p></div>
